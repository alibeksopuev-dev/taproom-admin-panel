...
import { Typography, Chip, CircularProgress, Dialog, DialogTitle, DialogContent, DialogActions } from '@mui/material'
                            ...
                            <Card key={order.id}>
                                ...
                                <CardBody>
                                    ...
                                    <Box sx={{ display: 'flex', gap: 1, mt: 0.5 }}>
                                        ...
                                        <Button
                                            size="small"
                                            onClick={() => setDiscountTarget(order)}
                                            sx={{
                                                bgcolor: '#14532d40',
                                                color: '#22c55e',
                                                fontSize: 12,
                                                ...
                                                minWidth: 44,
                                                textTransform: 'none',
                                                '&:hover': { bgcolor: '#14532d40', filter: 'brightness(1.3)' },
                                            }}
                                        >
                                            <Percent size={14} />
                                        </Button>
